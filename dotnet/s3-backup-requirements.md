# s3-backup (s3b) — Reverse-Engineered Requirements

Derived from the .NET source at `~/src/s3-backup` (solution `s3b.sln`: projects `s3b`, `s3bCommon`, `s3bDomain`, `s3bPersist`, `s3bProcess`, `s3bSqliteTemplate`, `s3bMSSqlTemplate`).
